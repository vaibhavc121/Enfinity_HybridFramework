...
public class OffboardingTaskTest extends BaseTest
{
    @Test(groups = "regression", retryAnalyzer = RetryAnalyzer.class, priority = 1)
    public void createOffboardingTask()
    {
        try
        {
            ...
            BasePage.globalSearchEquals("Offboarding Task");
            log("Searched for Offboarding Task");
            ...
            log("Verified: Offboarding task created successfully: " + "Complete Documentation");
        } catch (Exception e)
        {
    ...
    public void deleteOffboardingTask()
    {
        try
        {
            // String itSupportFile = FileUtils.getDataFile("SelfService", "SelfService", "SelfServiceData");
