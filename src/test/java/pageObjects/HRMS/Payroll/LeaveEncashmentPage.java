...
public class LeaveEncashmentPage extends BasePage
{
	...
	@FindBy(xpath="//span[normalize-space()='Leave Encashment']") WebElement leaveEncashment;
	
	@FindBy(xpath="//span[normalize-space()='New']") WebElement newbtn;
	
	@FindBy(xpath="//img[@id='LeaveAdjustment.EmployeeIdLookup_B-1Img']") WebElement empdd;
	
	@FindBy(xpath="//img[@id='LeaveAdjustment.LeaveTypeIdLookup_B-1Img']") WebElement leaveTypeDD;
	
	@FindBy(xpath="//div[contains(text(),'Condolence Leave')]") WebElement condolenceLeave;
