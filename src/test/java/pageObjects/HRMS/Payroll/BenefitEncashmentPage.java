...
public class BenefitEncashmentPage extends BasePage
{
	...
	@FindBy(xpath="//span[normalize-space()='Benefit Scheme Encashment']") WebElement benefitSchemeEncashment;
	
	@FindBy(xpath="//img[@id='BenefitSchemeEncashment.EffectiveDate_B-1Img']") WebElement effectiveDateDD;
	
	@FindBy(xpath="/html[1]/body[1]/div[6]/div[2]/form[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[2]/table[1]/tbody[1]/tr[1]/td[1]/div[1]/div[1]/div[1]/div[1]/div[1]/table[2]/tbody[1]/tr[1]/td[1]/table[1]/tbody[1]/tr[1]/td[1]/table[1]/tbody[1]/tr[1]/td[5]/span[1]") WebElement monthYear;
	
	@FindBy(xpath="//img[@id='BenefitSchemeEncashment.EffectiveDate_DDD_C_PMCImg']") WebElement previousMonth;
	
	@FindBy(xpath="//input[@id='BenefitSchemeEncashment.EffectiveDate_I']") WebElement effectiveDate;
	
	@FindBy(xpath="//img[@id='BenefitSchemeEncashment.EmployeeIdLookup_B-1Img']") WebElement empdd;
	
	@FindBy(xpath="//div[contains(text(),'001 | Vaibhav Chavan')]") WebElement emp;
	
	@FindBy(xpath="//img[@id='BenefitSchemeEncashment.EmployeeBenefitSchemeIdLookup_B-1Img']") WebElement benefitScemedd;
	
	@FindBy(css="td[id='BenefitSchemeEncashment.EmployeeBenefitSchemeIdLookup_DDD_gv_tcrow0'] div[class='lookup-text']") WebElement benefitSceme;
	
	@FindBy(xpath="//input[@id='BenefitSchemeEncashment.RequestedAmount_I']") WebElement requestedAmount;
	
	@FindBy(xpath="//input[@id='BenefitSchemeEncashment.ApprovedAmount_I']") WebElement approvedAmount;
	
	@FindBy(xpath="/html[1]/body[1]/div[6]/div[2]/div[1]/div[1]/div[1]/div[5]/div[1]/table[1]/tbody[1]/tr[2]/td[8]/div[1]/div[2]/div[1]/div[1]/div[1]/input[1]") WebElement filterCellReqAmt;
	
	@FindBy(xpath="/html[1]/body[1]/div[6]/div[2]/div[1]/div[1]/div[1]/div[6]/div[1]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[8]") WebElement resultReqAmt;
