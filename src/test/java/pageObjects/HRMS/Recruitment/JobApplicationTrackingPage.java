...
public class JobApplicationTrackingPage extends BasePage
{
    ...
    @FindBy(xpath = "(//td[@class='list-hyperlink'])[1]")
    ...
    @FindBy(xpath = "(//span[@class='dx-tab-text-span'])[4]")
    private WebElement assesment;
    @FindBy(xpath = "(//span[@class='dx-tab-text-span'])[5]")
    private WebElement advanceCandidateSearch;

    //region Skills
    @FindBy(xpath = "//input[contains(@id,'Skills')]")
    private WebElement skills;
    //endregion

    //region Experience (In Years)
    @FindBy(xpath = "//input[contains(@id,'MinimumWorkExperience')]")
    private WebElement minimumWorkExperience;
    @FindBy(xpath = "//input[contains(@id,'MaximumWorkExperience')]")
    private WebElement maximumWorkExperience;
    //endregion

    //region Salary Range
    @FindBy(xpath = "//input[contains(@id,'MinimumSalaryRange')]")
    private WebElement minimumSalaryRange;
    @FindBy(xpath = "//input[contains(@id,'MaximumSalaryRange')]")
    private WebElement maximumSalaryRange;
    //endregion

    //region Notic Period (In Days)
    @FindBy(xpath = "//input[contains(@id,'MinimumNoticePeriodInDays')]")
    private WebElement minimumNoticePeriodInDays;
    @FindBy(xpath = "//input[contains(@id,'MaximumNoticePeriodInDays')]")
    private WebElement maximumNoticePeriodInDays;
    //endregion

    //region Personal
    @FindBy(xpath = "//input[contains(@id,'NationalityCountries')]")
    private WebElement nationalityCountries;
    @FindBy(xpath = "//input[contains(@id,'VisaType')]")
    private WebElement visaType;
    @FindBy(xpath = "(//input[contains(@id,'Gender')])[2]")
    ...
    //region Age
    @FindBy(xpath = "//input[contains(@id,'MinimumAge')]")
    private WebElement minimumAge;
    @FindBy(xpath = "//input[contains(@id,'MaximumAge')]")
    private WebElement maximumAge;
    @FindBy(xpath = "//span[normalize-space()='Search Candidates']")
    ...
    //region Screening
    @FindBy(xpath = "(//h3[@class='widget-content text-right animation-pullDown'])[2]")
    private WebElement screeningPipeline;
    @FindBy(xpath = "//span[normalize-space()='Screening']")
    private WebElement screening1;
    @FindBy(xpath = "//input[contains(@id,'HiringTimeline')]")
    private WebElement statusDD;
    @FindBy(xpath = "//div[@id='StatusUpdateButton']//span[@class='dx-button-text'][normalize-space()='Update']")
    private WebElement update;
    @FindBy(xpath = "(//div[@class='widget-icon pull-left animation-fadeIn'])[2]")
    private WebElement screeningCount;
    @FindBy(xpath = "(//h3[@class='widget-content text-right animation-pullDown'])[3]")
    private WebElement interviewPipeline;
    //endregion
...
//    private WebElement interviewButton1;
    ...
    private WebElement offeredPipeline;
    @FindBy(xpath = "(//span[@class='dx-button-text'][normalize-space()='Cancel'])[2]")
    private WebElement cancelPopupInterview;

    //region Schedule Interview Popup
    @FindBy(xpath = "//input[contains(@id,'InterviewType')]")
    ...
    @FindBy(xpath = "(//span[@class='dx-button-text'][normalize-space()='OK'])[2]")
    ...
    @FindBy(xpath = "//input[contains(@id,'InterviewerEmployeeId')]")
    private WebElement interviewer;
    @FindBy(xpath = "//input[contains(@id,'GuestInterviewerIds')]")
    private WebElement guestInterviewer;
    @FindBy(xpath = "//span[@class='dx-vam dxm-contentText'][normalize-space()='Save']")
    private WebElement save;
    @FindBy(xpath = "//span[normalize-space()='Ok']")
    private WebElement ok;
    @FindBy(xpath = "(//span[@class='dx-button-text'][normalize-space()='Cancel'])[3]")
    private WebElement cancel;
    @FindBy(xpath = "(//i[@class='dx-icon dx-icon-close'])[2]")
    private WebElement closeSchduledInterviewPopupIcon;
    @FindBy(xpath = "//label[normalize-space()='Scheduled']")
    private WebElement interviewStatus;
    //endregion
    //endregion

    //region Offered
    @FindBy(xpath = "//td[normalize-space()='Not Generated']")
    private WebElement offerStatus;
    @FindBy(xpath = "(//td[@class='verticalAlign'])[8]")
    private WebElement offerStatus1;
    @FindBy(xpath = "//i[@class='dx-icon dx-icon-message']")
    private WebElement offerIcon;
    @FindBy(xpath = "(//h3[@class='widget-content text-right animation-pullDown'])[5]")
    private WebElement hiredPipeline;
    ...
    @FindBy(id = "JobOffer.JobOfferReportIdLookup_I")
    private WebElement jobOfferTemplateDD;
    @FindBy(id = "JobOfferSalaryComponents_RPHT")
    private WebElement salaryComponentsSection;
    @FindBy(id = "JobOfferSalaryComponent_SalaryComponentId_I")
    private WebElement SalaryComponentDD;
    @FindBy(xpath = "(//div[@class='dxgBCTC dx-ellipsis'])[2]")
    private WebElement salaryAmount;
    @FindBy(id = "JobOfferLeaveTypes_RPHT")
    private WebElement leaveTypes;
    @FindBy(xpath = "//td[contains(text(),'Leave Type')]")
    private WebElement leaveTypeLabel;
    @FindBy(id = "JobOfferLeaveType_LeaveTypeId_I")
    private WebElement LeaveTypeDD;
    @FindBy(xpath = "//span[normalize-space()='Generate Offer']")
    private WebElement generateOffer;
    ...
    @FindBy(xpath = "(//h3[@class='widget-content text-right animation-pullDown'])[6]")
    private WebElement rejectedPipeline;

    //region Initiate Onboarding
    @FindBy(xpath = "//i[@class='dx-icon dx-icon-bolt-solid']")
    private WebElement initiateOnboardingIcon;
    @FindBy(xpath = "//input[contains(@id,'OnboardingProcessId')]")
    ...
    @FindBy(xpath = "(//input[contains(@id,'DepartmentId')])[2]")
    private WebElement department;
    @FindBy(xpath = "(//input[contains(@id,'DesignationId')])[2]")
    private WebElement designation;
    @FindBy(xpath = "//input[contains(@id,'WorkLocationId')]")
    private WebElement workLocation;
    @FindBy(xpath = "(//div[@aria-label='Editor content'])[2]")
    private WebElement welcome;
    @FindBy(xpath = "//input[contains(@id,'WelcomeUrl')]")
    private WebElement welcomeUrl;
    ...
    @FindBy(xpath = "(//span[@class='dx-button-text'][normalize-space()='Save'])[3]")
    private WebElement save1;
    //endregion

    @FindBy(xpath = "//span[normalize-space()='Initate']")
    ...
    @FindBy(xpath = "//i[@class='dx-icon dx-icon-user']")
    private WebElement convertToEmployeeIcon;
    //endregion
    ...
    public void selectCandidate(String candidateName)
    {
        ...
        {
            for (WebElement pagination : waitForElements2(By.xpath("//div[@class='dx-page']")))
            {
                pagination.click();
                waitTS(2);
                try
