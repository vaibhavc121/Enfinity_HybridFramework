...
public class JobPage extends BasePage
{
    ...
    private WebElement templateUploadbutton;
    @FindBy(xpath = "//input[contains(@id,'Template')]")
    private WebElement templateDD;
    ...
    @FindBy(xpath = "//input[contains(@id,'JobCompanyId')]")
